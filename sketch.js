...
border1 = createSprite(470,205,5,45)
border2 = createSprite(845,205,5,45)
border3 = createSprite(660,185,375,5)
border4 = createSprite(660,225,375,5)
...
function draw() {
  ...
  if (World.frameCount % 150 == 0) {
   ...
   if(pinkCG.isTouching(mainCyclist)){
    ...
    textSize(20);
    fill(225)
    text("Press Up Arrow for restarting the game!",480,210)
